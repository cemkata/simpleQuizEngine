		...
		<div id="container">
			...
			<div id="config">
			  ...
			  % end #% if page_config['Display_GUI']:
				...
				<br>
				<label class="tooltip_hidden">Exsam mode:<span class="tooltiptext">Hides the check answer button.</span></label><input type="checkbox" id="hide_answer_btn" {{page_config['Exsam_mode']}} {{page_config['Exsam_mode_read_only']}}><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
				<label class="tooltip_hidden">Read only answer:<span class="tooltiptext">After showing the answer the answer cannot be chnaged</span></label><input type="checkbox" id="readonly_answer" {{page_config['Read_only_answers']}} {{page_config['Read_only_answers_read_only']}}><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
